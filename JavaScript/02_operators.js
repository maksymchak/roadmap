...
/*================================= постфиксные/префиксные  выражения ===================================================*/

Оператор инкремента увеличивает на единицу(инкрементирует) операнд и возвращает значение.

	* Если операция используется как постфикс, с оператором после операнда (например, x++), значение 
		операнда возвращается, а затем увеличивается на единицу.
	* Если используется префиксная форма с оператором перед операндом (например, ++x), значение операнда 
		возвращается увеличенным на единицу.
